...
class ResNet50_nFC(nn.Module):
    def __init__(self, class_num):
        ...
        for c in range(self.class_num):
            self.__setattr__('class_%d' % c, ClassBlock(
                self.num_ftrs, num_bottleneck))
...
class ResNet50_nFC_newbaseline(nn.Module):
    def __init__(self, class_num):
        super(ResNet50_nFC_newbaseline, self).__init__()
        self.model_name = 'resnet50_nfc_baseline'
        self.class_num = class_num
